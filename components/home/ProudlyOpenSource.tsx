...
const ProudlyOpenSource = () => {
    return (
        <div className="container pt-[55px] sm:pt-[230px] pb-[53px] sm:pb-[174px] px-8 sm:px-0">
            ...
            <div className="flex justify-center">
                <a className="shadow-[0px_0.5px_4px_0px_rgba(0,0,0,0.15)_inset] drop_shadow rounded-full flex items-center gap-[3px] sm:gap-2 py-0.5 sm:py-3 px-6" href="https://github.com/Nutlope/pdftochat">
                    <Image
